            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-custom mb-0">
                    ...
                    <tbody>
                        ...
                        <tr v-else-if="!journaux.length"><td colspan="8" class="text-center py-5 text-muted">Aucun journal configuré</td></tr>
                        <tr v-for="j in journaux" :key="j.id">
                            ...
                            <td><span class="badge bg-info">@{{ j.devise_defaut || 'CDF' }}</span></td>
                            <td>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select border-2" v-model="form.devise_defaut" required>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label fw-medium" for="chk_an">Analytique obligatoire</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mt-2">
                                            <label class="form-label fs-12 mb-0 fw-bold">Ordre d'affichage</label>
                                            <input type="number" class="form-control form-control-sm border-2" v-model.number="form.ordre_affichage">
                                        </div>
                                    </div>
                                </div>
                            </div>
