...
<div class="content pb-0" id="App" v-cloak>
    ...
    <div class="card border-0 shadow-sm" v-if="data">
        <div class="card-header bg-white border-bottom-0 pt-4 px-4 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="mb-0 text-primary fw-bold">TVA collectée</h4>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-fiscalite mb-0">
                    <thead>
                        <tr>
                            <th>Compte</th>
                            <th class="text-end">Montant crédit net (@{{ data.devise }})</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr v-if="!data.detail.length">
                            <td colspan="2" class="text-muted text-center py-5">
                                ...
                                Aucun mouvement TVA collectée sur la période.
                            </td>
                        </tr>
                    </tbody>
                    <tfoot class="bg-light fw-bold" v-if="data.detail.length">
                        <tr>
                            ...
                            <td class="text-end pe-4 text-primary">@{{ fmt(data.total) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
    ...
    <div v-else-if="!isLoading" class="alert alert-info shadow-sm border-0">
        <div class="d-flex align-items-center">
            ...
            <div>Aucune donnée — vérifiez l'exercice et les écritures validées (comptes 443x).</div>
        </div>
    </div>
    </template>
</div>
