...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 27 mai 2026 à 14:29
...
CREATE TABLE `audit_logs` (
  ...
  `reference` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(6, 1, 1, 'creation', 'demande_fonds', 1, 'DF-2026-0001', 'Création demande DF-2026-0001', NULL, '169.159.212.106', '2026-05-20 08:05:39', '2026-05-20 08:05:39'),
(7, 1, 1, 'creation', 'ecriture', 10, 'HA-2026-00002', 'creation — HA-2026-00002 Écriture Journal des achats', '{\"statut\":\"validee\",\"journal_id\":1,\"total_debit\":700000,\"total_credit\":700000}', '102.206.157.184', '2026-05-25 09:47:57', '2026-05-25 09:47:57'),
(8, 1, 1, 'validation', 'ecriture', 10, 'HA-2026-00002', 'validation — HA-2026-00002 Écriture Journal des achats', '{\"statut\":\"validee\",\"journal_id\":1,\"total_debit\":700000,\"total_credit\":700000}', '102.206.157.184', '2026-05-25 09:47:57', '2026-05-25 09:47:57'),
(9, 1, 1, 'creation', 'facture', 2, 'FAC-2026-0002', 'Création facture FAC-2026-0002', '{\"type\":\"vente_client\",\"montant_ttc\":\"8000000.00\"}', '127.0.0.1', '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(10, 1, 1, 'creation', 'ecriture', 11, 'VT-2026-00003', 'creation — VT-2026-00003 jfjfj', '{\"statut\":\"validee\",\"journal_id\":2,\"total_debit\":8000000,\"total_credit\":8000000}', '127.0.0.1', '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(11, 1, 1, 'validation', 'ecriture', 11, 'VT-2026-00003', 'validation — VT-2026-00003 jfjfj', '{\"statut\":\"validee\",\"journal_id\":2,\"total_debit\":8000000,\"total_credit\":8000000}', '127.0.0.1', '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(12, 1, 1, 'validation_comptable', 'facture', 2, 'FAC-2026-0002', 'Écriture de validation — FAC-2026-0002', '{\"ecriture_id\":11}', '127.0.0.1', '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(13, 1, 1, 'validation', 'facture', 2, 'FAC-2026-0002', 'Validation facture FAC-2026-0002', NULL, '127.0.0.1', '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(14, 1, 1, 'creation', 'ecriture', 12, 'CA-2026-05-0002', 'creation — CA-2026-05-0002 Paiement PAY-2026-0001 — FAC-2026-0002', '{\"statut\":\"validee\",\"journal_id\":4,\"total_debit\":8000000,\"total_credit\":8000000}', '127.0.0.1', '2026-05-26 11:04:14', '2026-05-26 11:04:14'),
(15, 1, 1, 'validation', 'ecriture', 12, 'CA-2026-05-0002', 'validation — CA-2026-05-0002 Paiement PAY-2026-0001 — FAC-2026-0002', '{\"statut\":\"validee\",\"journal_id\":4,\"total_debit\":8000000,\"total_credit\":8000000}', '127.0.0.1', '2026-05-26 11:04:14', '2026-05-26 11:04:14'),
(16, 1, 1, 'paiement_comptable', 'paiement', 3, 'PAY-2026-0001', 'Écriture de paiement — PAY-2026-0001', '{\"ecriture_id\":12,\"facture_id\":2}', '127.0.0.1', '2026-05-26 11:04:14', '2026-05-26 11:04:14'),
(17, 1, 1, 'paiement', 'facture', 2, 'FAC-2026-0002', 'Paiement PAY-2026-0001 — FAC-2026-0002', '{\"paiement_id\":3,\"montant\":8000000}', '127.0.0.1', '2026-05-26 11:04:14', '2026-05-26 11:04:14'),
(18, 1, 1, 'creation', 'facture', 3, 'FAC-2026-0003', 'Création facture FAC-2026-0003', '{\"type\":\"vente_client\",\"montant_ttc\":\"59.16\"}', '127.0.0.1', '2026-05-26 12:08:48', '2026-05-26 12:08:48'),
(19, 1, 1, 'creation', 'demande_fonds', 2, 'DF-2026-0002', 'Création demande DF-2026-0002', NULL, '127.0.0.1', '2026-05-26 12:22:40', '2026-05-26 12:22:40'),
(20, 1, 1, 'creation', 'facture', 4, 'FAC-2026-0004', 'Création facture FAC-2026-0004', '{\"type\":\"vente_client\",\"montant_ttc\":\"870.00\"}', '127.0.0.1', '2026-05-26 12:26:12', '2026-05-26 12:26:12'),
(21, 1, 1, 'creation', 'ecriture', 13, 'VRD00001', 'creation — VRD00001 VENETTETETET', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":800,\"total_credit\":800}', '127.0.0.1', '2026-05-26 13:12:03', '2026-05-26 13:12:03'),
(22, 1, 1, 'validation', 'ecriture', 13, 'VRD00001', 'validation — VRD00001 VENETTETETET', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":800,\"total_credit\":800}', '127.0.0.1', '2026-05-26 13:12:03', '2026-05-26 13:12:03'),
(23, 1, 1, 'creation', 'ecriture', 14, 'VRD00002', 'creation — VRD00002 uiifnru', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":8000,\"total_credit\":8000}', '127.0.0.1', '2026-05-26 15:22:25', '2026-05-26 15:22:25'),
(24, 1, 1, 'validation', 'ecriture', 14, 'VRD00002', 'validation — VRD00002 uiifnru', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":8000,\"total_credit\":8000}', '127.0.0.1', '2026-05-26 15:22:25', '2026-05-26 15:22:25'),
(25, 1, 1, 'creation', 'ecriture', 15, 'VRD00003', 'creation — VRD00003 test dollars', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":500,\"total_credit\":500}', '127.0.0.1', '2026-05-27 09:12:27', '2026-05-27 09:12:27'),
(26, 1, 1, 'validation', 'ecriture', 15, 'VRD00003', 'validation — VRD00003 test dollars', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":500,\"total_credit\":500}', '127.0.0.1', '2026-05-27 09:12:27', '2026-05-27 09:12:27'),
(27, 1, 1, 'creation', 'ecriture', 16, 'VRD00004', 'creation — VRD00004 UIHIDUEZDIU', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":600,\"total_credit\":600}', '127.0.0.1', '2026-05-27 10:54:25', '2026-05-27 10:54:25'),
(28, 1, 1, 'validation', 'ecriture', 16, 'VRD00004', 'validation — VRD00004 UIHIDUEZDIU', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":600,\"total_credit\":600}', '127.0.0.1', '2026-05-27 10:54:25', '2026-05-27 10:54:25'),
(29, 1, 1, 'creation', 'ecriture', 17, 'VRD00005', 'creation — VRD00005 FUNI', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":100,\"total_credit\":100}', '127.0.0.1', '2026-05-27 10:56:43', '2026-05-27 10:56:43'),
(30, 1, 1, 'validation', 'ecriture', 17, 'VRD00005', 'validation — VRD00005 FUNI', '{\"statut\":\"validee\",\"journal_id\":12,\"total_debit\":100,\"total_credit\":100}', '127.0.0.1', '2026-05-27 10:56:43', '2026-05-27 10:56:43');
...
CREATE TABLE `axes_analytiques` (
  ...
  `ordre_affichage` smallint(5) UNSIGNED NOT NULL DEFAULT 10,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `axes_analytiques`
--

INSERT INTO `axes_analytiques` (`id`, `societe_id`, `code`, `libelle`, `description`, `actif`, `ordre_affichage`, `created_at`, `updated_at`) VALUES
(1, 1, 'PROJET', 'Projet', NULL, 1, 1, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(2, 1, 'DEPT', 'Département', NULL, 1, 2, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(3, 1, 'SITE', 'Site', NULL, 1, 3, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(4, 1, 'CCP', 'CCPROJET', 'PROJE', 1, 10, '2026-05-27 10:06:26', '2026-05-27 10:06:26');
...
INSERT INTO `bons_commande` (`id`, `societe_id`, `tiers_id`, `numero`, `date_commande`, `date_livraison_prevue`, `statut`, `devise`, `montant_ht`, `montant_ttc`, `notes`, `cree_par`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 'BC-2026-0001', '2026-05-26', NULL, 'brouillon', 'USD', 51.50, 51.50, NULL, 1, '2026-05-26 10:56:19', '2026-05-26 10:56:19', NULL);
...
CREATE TABLE `bon_commande_lignes` (
  ...
  `prix_unitaire` decimal(18,4) NOT NULL DEFAULT 0.0000,
  `montant_ht` decimal(18,2) NOT NULL DEFAULT 0.00,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Déchargement des données de la table `bon_commande_lignes`
--

INSERT INTO `bon_commande_lignes` (`id`, `bon_commande_id`, `produit_id`, `ordre`, `libelle`, `quantite`, `prix_unitaire`, `montant_ht`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 'Ordinateur', 1.0300, 50.0000, 51.50, '2026-05-26 10:56:19', '2026-05-26 10:56:19');

-- --------------------------------------------------------

--
-- Structure de la table `bon_livraison_lignes`
--
...
--
-- Déchargement des données de la table `demandes_fonds`
--

INSERT INTO `demandes_fonds` (`id`, `societe_id`, `workflow_definition_id`, `workflow_etape_courante_id`, `numero`, `demandeur_id`, `montant`, `devise`, `motif`, `journal_id`, `section_analytique_id`, `statut`, `compte_debit`, `compte_credit`, `ecriture_id`, `motif_rejet`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 2, 'DF-2026-0001', 1, 200.00, 'CDF', 'Gh', NULL, NULL, 'en_validation', NULL, NULL, NULL, NULL, '2026-05-20 08:05:39', '2026-05-20 08:05:39', NULL),
(2, 1, 1, 2, 'DF-2026-0002', 1, 500.00, 'USD', 'je fais la demande', NULL, NULL, 'en_validation', NULL, NULL, NULL, NULL, '2026-05-26 12:22:40', '2026-05-26 12:22:40', NULL);
...
--
-- Déchargement des données de la table `demande_fonds_historiques`
--

INSERT INTO `demande_fonds_historiques` (`id`, `demande_fonds_id`, `user_id`, `action`, `description`, `metadata`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'creation', 'Demande créée', NULL, '2026-05-20 08:05:39', '2026-05-20 08:05:39'),
(2, 2, 1, 'creation', 'Demande créée', NULL, '2026-05-26 12:22:40', '2026-05-26 12:22:40');
...
(10, 1, 1, 1, 'HA-2026-00002', NULL, '2026-05-25', NULL, NULL, '2026-05-25', 'Écriture Journal des achats', 'validee', 'normale', 'Lorem', 'FAC-0001212', 700000.00, 700000.00, 'CDF', 1.000000, 1, 1, '2026-05-25 09:47:57', 1, NULL, NULL, 0, NULL, NULL, '2026-05-25 09:47:57', '2026-05-25 09:47:57', NULL),
(11, 1, 1, 2, 'VT-2026-00003', NULL, '2026-05-25', NULL, NULL, NULL, 'jfjfj', 'validee', 'normale', 'FAC-2026-0002', 'FAC-2026-0002', 8000000.00, 8000000.00, 'CDF', 2200.000000, 1, 1, '2026-05-25 18:09:18', 1, NULL, NULL, 0, NULL, NULL, '2026-05-25 18:09:18', '2026-05-25 18:09:18', NULL),
(12, 1, 1, 4, 'CA-2026-05-0002', NULL, '2026-05-26', NULL, NULL, NULL, 'Paiement PAY-2026-0001 — FAC-2026-0002', 'validee', 'normale', 'PAY-2026-0001', 'FAC-2026-0002', 8000000.00, 8000000.00, 'CDF', 2200.000000, 1, 1, '2026-05-26 11:04:14', 1, NULL, NULL, 0, NULL, NULL, '2026-05-26 11:04:14', '2026-05-26 11:04:14', NULL),
(13, 1, 1, 12, 'VRD00001', NULL, '2026-05-26', NULL, NULL, '2026-05-27', 'VENETTETETET', 'validee', 'normale', 'FRNEIOF', 'ER', 800.00, 800.00, 'CDF', 1.000000, 1, 1, '2026-05-26 13:12:03', 1, NULL, NULL, 0, NULL, NULL, '2026-05-26 13:12:03', '2026-05-26 13:12:03', NULL),
(14, 1, 1, 12, 'VRD00002', NULL, '2026-05-26', NULL, NULL, NULL, 'uiifnru', 'validee', 'normale', 'iuefuief', 'uene', 8000.00, 8000.00, 'USD', 2300.000001, 1, 1, '2026-05-26 15:22:24', 1, NULL, NULL, 0, NULL, NULL, '2026-05-26 15:22:24', '2026-05-26 15:22:24', NULL),
(15, 1, 1, 12, 'VRD00003', NULL, '2026-05-27', NULL, NULL, '2026-05-27', 'test dollars', 'validee', 'normale', '5fe8', '255f', 500.00, 500.00, 'USD', 2200.000000, 1, 1, '2026-05-27 09:12:27', 1, NULL, NULL, 0, NULL, NULL, '2026-05-27 09:12:27', '2026-05-27 09:12:27', NULL),
(16, 1, 1, 12, 'VRD00004', NULL, '2026-05-27', NULL, NULL, '2026-05-27', 'UIHIDUEZDIU', 'validee', 'normale', '5DDE', 'DE55', 600.00, 600.00, 'USD', 2200.000000, 1, 1, '2026-05-27 10:54:23', 1, NULL, NULL, 0, NULL, NULL, '2026-05-27 10:54:23', '2026-05-27 10:54:23', NULL),
(17, 1, 1, 12, 'VRD00005', NULL, '2026-05-27', NULL, NULL, NULL, 'FUNI', 'validee', 'normale', '55D', '85DS', 100.00, 100.00, 'USD', 2200.000000, 1, 1, '2026-05-27 10:56:43', 1, NULL, NULL, 0, NULL, NULL, '2026-05-27 10:56:43', '2026-05-27 10:56:43', NULL);
...
CREATE TABLE `etats_financiers` (
  ...
  `societe_id` bigint(20) UNSIGNED NOT NULL,
  `exercice_id` bigint(20) UNSIGNED NOT NULL,
  `type` enum('bilan','compte_resultat','tafire','variation_capitaux_propres','balance_generale','balance_auxiliaire','grand_livre','balance_agee','autre') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_arrete` date NOT NULL,
  `donnees` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `fichier_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `factures` (`id`, `societe_id`, `exercice_id`, `type_document`, `numero`, `tiers_id`, `section_analytique_id`, `facture_origine_id`, `date_facture`, `date_echeance`, `statut`, `objet`, `montant_ht`, `montant_tva`, `montant_ttc`, `taux_tva`, `tva_active`, `devise`, `ecriture_validation_id`, `notes`, `cree_par`, `valide_par`, `valide_le`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 'vente_client', 'FAC-2026-0001', 2, NULL, NULL, '2026-05-19', NULL, 'validee', 'CAMERAS', 130000.00, 0.00, 130000.00, 16.00, 0, 'CDF', 9, NULL, 1, 1, '2026-05-19 17:36:58', '2026-05-19 17:36:09', '2026-05-19 17:36:58', NULL),
(2, 1, 1, 'vente_client', 'FAC-2026-0002', 2, NULL, NULL, '2026-05-25', NULL, 'payee', 'jfjfj', 8000000.00, 0.00, 8000000.00, 16.00, 0, 'CDF', 11, NULL, 1, 1, '2026-05-25 18:09:18', '2026-05-25 18:09:18', '2026-05-26 11:04:14', NULL),
(3, 1, 1, 'vente_client', 'FAC-2026-0003', 2, NULL, NULL, '2026-05-26', NULL, 'brouillon', 'FACTURE VIDEO SURVEILLANCE', 51.00, 8.16, 59.16, 16.00, 1, 'USD', NULL, 'CONDITION UN DKNN', 1, NULL, NULL, '2026-05-26 12:08:48', '2026-05-26 12:08:48', NULL),
(4, 1, 1, 'vente_client', 'FAC-2026-0004', 2, NULL, NULL, '2026-05-26', NULL, 'brouillon', 'IDEO ACCESS BANK KIMPWANZA', 750.00, 120.00, 870.00, 16.00, 1, 'USD', NULL, NULL, 1, NULL, NULL, '2026-05-26 12:26:12', '2026-05-26 12:26:12', NULL);
...
CREATE TABLE `facture_lignes` (
  ...
  `ordre` smallint(5) UNSIGNED NOT NULL DEFAULT 1,
  `libelle` varchar(255) NOT NULL,
  `rubrique` varchar(120) DEFAULT NULL,
  `est_rubrique` tinyint(1) NOT NULL DEFAULT 0,
  `quantite` decimal(18,4) NOT NULL DEFAULT 1.0000,
...
INSERT INTO `facture_lignes` (`id`, `facture_id`, `produit_id`, `ordre`, `libelle`, `rubrique`, `est_rubrique`, `quantite`, `prix_unitaire`, `montant_ht`, `compte_comptable`, `section_analytique_id`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 1, 'CAMERA HIVKISION4MP', NULL, 0, 1.0000, 50000.00, 50000.00, NULL, NULL, '2026-05-19 17:36:10', '2026-05-19 17:36:10'),
(2, 1, NULL, 2, 'NVR', NULL, 0, 1.0000, 80000.00, 80000.00, NULL, NULL, '2026-05-19 17:36:10', '2026-05-19 17:36:10'),
(3, 2, NULL, 1, 'camer', NULL, 0, 1.0000, 8000000.00, 8000000.00, NULL, NULL, '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(4, 3, 1, 1, 'Ordinateur', 'PRESTATIONS', 0, 1.0200, 50.00, 51.00, NULL, NULL, '2026-05-26 12:08:48', '2026-05-26 12:08:48'),
(5, 4, 1, 1, 'Ordinateur', NULL, 0, 1.0000, 50.00, 50.00, NULL, NULL, '2026-05-26 12:26:12', '2026-05-26 12:26:12'),
(6, 4, NULL, 2, 'ACCESS', 'ACCESS', 1, 0.0000, 0.00, 0.00, NULL, NULL, '2026-05-26 12:26:12', '2026-05-26 12:26:12'),
(7, 4, NULL, 3, 'CAHIER', NULL, 0, 1.0000, 700.00, 700.00, NULL, NULL, '2026-05-26 12:26:12', '2026-05-26 12:26:12');
...
CREATE TABLE `imports_logs` (
  ...
  `societe_id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `type_import` enum('releve_bancaire','plan_comptable','tiers','ecritures_csv','factures') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `erreurs` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `statut` enum('en_cours','termine','echec') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en_cours',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `journal_audit` (
  ...
  `entite_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entite_id` bigint(20) UNSIGNED DEFAULT NULL,
  `avant` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `apres` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `ip_address` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `journaux` (
  ...
  `analytique_obligatoire` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `journaux` (`id`, `societe_id`, `code`, `libelle`, `type`, `compte_contrepartie`, `prefixe_piece`, `prochain_numero`, `format_numerotation`, `padding_numero`, `saisie_tiers_obligatoire`, `analytique_obligatoire`, `saisie_lettrage_auto`, `mode_brouillard`, `devise_defaut`, `actif`, `ordre_affichage`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'HA', 'Journal des achats', 'achats', '401', 'HA-', 3, 'annuel', 5, 1, 0, 0, 0, NULL, 1, 1, '2026-05-17 16:13:12', '2026-05-25 09:47:57', NULL),
(2, 1, 'VT', 'Journal des ventes', 'ventes', '411', 'VT-', 4, 'annuel', 5, 1, 0, 0, 0, NULL, 1, 2, '2026-05-17 16:13:12', '2026-05-25 18:09:18', NULL),
(3, 1, 'BQ', 'Journal de banque', 'banque', '521', 'BQ-', 2, 'mensuel', 4, 0, 0, 0, 0, NULL, 1, 3, '2026-05-17 16:13:12', '2026-05-17 18:48:09', NULL),
(4, 1, 'CA', 'Journal de caisse', 'caisse', '571', 'CA-', 3, 'mensuel', 4, 0, 0, 0, 0, NULL, 1, 4, '2026-05-17 16:13:12', '2026-05-26 11:04:14', NULL),
(5, 1, 'OD', 'Opérations diverses', 'operations_diverses', NULL, 'OD-', 5, 'annuel', 5, 0, 0, 0, 0, NULL, 1, 5, '2026-05-17 16:13:12', '2026-05-18 18:49:49', NULL),
(6, 1, 'SA', 'Journal des salaires', 'salaires', '422', 'SA-', 1, 'mensuel', 3, 0, 0, 0, 0, NULL, 1, 6, '2026-05-17 16:13:12', '2026-05-17 16:13:12', NULL),
(7, 1, 'IM', 'Journal des immobilisations', 'immobilisations', NULL, 'IM-', 1, 'annuel', 4, 0, 0, 0, 0, NULL, 1, 7, '2026-05-17 16:13:12', '2026-05-17 16:13:12', NULL),
(8, 1, 'EF', 'Journal des effets', 'effets', NULL, 'EF-', 1, 'annuel', 4, 1, 0, 1, 0, NULL, 0, 8, '2026-05-17 16:13:12', '2026-05-17 16:13:12', NULL),
(9, 1, 'AN', 'Journal d\'à-nouveau', 'ouverture', NULL, 'AN-', 1, 'annuel', 3, 0, 0, 0, 0, NULL, 1, 9, '2026-05-17 16:13:12', '2026-05-17 16:13:12', NULL),
(10, 1, 'CL', 'Journal de clôture', 'cloture', NULL, 'CL-', 1, 'annuel', 3, 0, 0, 0, 0, NULL, 1, 10, '2026-05-17 16:13:12', '2026-05-17 16:13:12', NULL),
(11, 1, 'SI', 'Journal de simulation', 'simulation', NULL, 'SI-', 1, 'annuel', 4, 0, 0, 0, 1, NULL, 0, 11, '2026-05-17 16:13:12', '2026-05-17 16:13:12', NULL),
(12, 1, 'VTD', 'JOURNAL DOLLARS VENTE', 'ventes', NULL, 'VRD', 6, 'continu', 5, 1, 0, 0, 0, 'USD', 1, 10, '2026-05-26 13:07:47', '2026-05-27 10:56:43', NULL);
...
(21, 10, 1, 1, 1, '601100', 708, 1, '2026-05-25', 'Écriture Journal des achats', 700000.00, 0.00, 'CDF', NULL, 1.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-05-25 09:47:57', '2026-05-25 09:47:57'),
(22, 10, 1, 1, 1, '401100', 430, 1, '2026-05-25', 'Écriture Journal des achats', 0.00, 700000.00, 'CDF', NULL, 1.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, '2026-05-25 09:47:57', '2026-05-25 09:47:57'),
(23, 11, 1, 1, 2, '411200', 452, 2, '2026-05-25', 'jfjfj', 8000000.00, 0.00, 'CDF', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(24, 11, 1, 1, 2, '701100', 922, NULL, '2026-05-25', 'jfjfj', 0.00, 8000000.00, 'CDF', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, '2026-05-25 18:09:18', '2026-05-25 18:09:18'),
(25, 12, 1, 1, 4, '570050', 1143, NULL, '2026-05-26', 'Paiement PAY-2026-0001 — FAC-2026-0002', 8000000.00, 0.00, 'CDF', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-05-26 11:04:14', '2026-05-26 11:04:14'),
(26, 12, 1, 1, 4, '411200', 452, 2, '2026-05-26', 'Paiement PAY-2026-0001 — FAC-2026-0002', 0.00, 8000000.00, 'CDF', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, '2026-05-26 11:04:14', '2026-05-26 11:04:14'),
(27, 13, 1, 1, 12, '411100', 451, 2, '2026-05-26', 'VZYBFIUZBFZF DOLLARS', 800.00, 0.00, 'CDF', NULL, 1.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-05-26 13:12:03', '2026-05-26 13:12:03'),
(28, 13, 1, 1, 12, '701100', 922, 2, '2026-05-26', 'BYBDZUIDBIUDZ DOLLARS', 0.00, 800.00, 'CDF', NULL, 1.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, '2026-05-26 13:12:03', '2026-05-26 13:12:03'),
(29, 14, 1, 1, 12, '411200', 452, 3, '2026-05-26', 'frfoir,fio,', 8000.00, 0.00, 'USD', NULL, 2300.000001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-05-26 15:22:25', '2026-05-26 15:22:25'),
(30, 14, 1, 1, 12, '701100', 922, 3, '2026-05-26', 'oifienoiefnoinefirf', 0.00, 8000.00, 'USD', NULL, 2300.000001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, '2026-05-26 15:22:25', '2026-05-26 15:22:25'),
(31, 15, 1, 1, 12, '411200', 452, 2, '2026-05-27', 'test dollars', 0.00, 500.00, 'USD', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-05-27 09:12:27', '2026-05-27 09:12:27'),
(32, 15, 1, 1, 12, '570050', 1143, 1, '2026-05-27', 'tes dollars', 500.00, 0.00, 'USD', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, '2026-05-27 09:12:27', '2026-05-27 09:12:27'),
(33, 16, 1, 1, 12, '570050', 1143, 2, '2026-05-27', 'IUEFHIUZE', 600.00, 0.00, 'USD', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-05-27 10:54:26', '2026-05-27 10:54:26'),
(34, 16, 1, 1, 12, '701100', 922, 2, '2026-05-27', 'ONFIOFZUFIUZ', 0.00, 600.00, 'USD', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, 4, 7, 2, NULL, '2026-05-27 10:54:26', '2026-05-27 10:54:26'),
(35, 17, 1, 1, 12, '601100', 708, 2, '2026-05-27', 'FNE', 100.00, 0.00, 'USD', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, 4, 7, 1, NULL, '2026-05-27 10:56:43', '2026-05-27 10:56:43'),
(36, 17, 1, 1, 12, '570050', 1143, 2, '2026-05-27', 'IUERE', 0.00, 100.00, 'USD', NULL, 2200.000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, '2026-05-27 10:56:43', '2026-05-27 10:56:43');

-- --------------------------------------------------------

--
-- Structure de la table `lignes_ecritures_analytiques`
--

CREATE TABLE `lignes_ecritures_analytiques` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ligne_ecriture_id` bigint(20) UNSIGNED NOT NULL,
  `ecriture_id` bigint(20) UNSIGNED NOT NULL,
  `societe_id` bigint(20) UNSIGNED NOT NULL,
  `exercice_id` bigint(20) UNSIGNED NOT NULL,
  `journal_id` bigint(20) UNSIGNED NOT NULL,
  `axe_analytique_id` bigint(20) UNSIGNED NOT NULL,
  `section_analytique_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Déchargement des données de la table `lignes_ecritures_analytiques`
--

INSERT INTO `lignes_ecritures_analytiques` (`id`, `ligne_ecriture_id`, `ecriture_id`, `societe_id`, `exercice_id`, `journal_id`, `axe_analytique_id`, `section_analytique_id`, `montant`, `pourcentage`, `created_at`, `updated_at`) VALUES
(1, 34, 16, 1, 1, 12, 4, 7, 600.00, 100.00, '2026-05-27 10:54:26', '2026-05-27 10:54:26'),
(2, 35, 17, 1, 1, 12, 4, 7, 100.00, 100.00, '2026-05-27 10:56:43', '2026-05-27 10:56:43');
...
(17, '2026_05_25_120000_enrich_produits_stock_and_prices', 4),
(18, '2026_05_26_100000_enhance_produits_and_stock_tables', 5),
(19, '2026_05_27_120000_societe_banques_facture_enhancements', 6),
(20, '2026_05_27_150000_add_est_rubrique_to_facture_lignes', 7),
(21, '2026_05_28_100000_create_taches_tables', 8),
(22, '2026_05_29_100000_analytique_complet', 9);
...
CREATE TABLE `mouvements_stock` (
  ...
  `stock_avant` decimal(18,4) NOT NULL DEFAULT 0.0000,
  `stock_apres` decimal(18,4) NOT NULL DEFAULT 0.0000,
...
INSERT INTO `mouvements_stock` (`id`, `numero`, `societe_id`, `produit_id`, `entrepot_id`, `type_mouvement`, `quantite`, `stock_avant`, `stock_apres`, `reference_type`, `reference_id`, `libelle`, `date_mouvement`, `user_id`, `created_at`, `updated_at`) VALUES
(1, NULL, 1, 1, NULL, 'entree', 80.0000, 0.0000, 80.0000, NULL, NULL, 'entree', '2026-05-26', 1, '2026-05-26 10:55:49', '2026-05-26 10:55:49'),
(2, NULL, 1, 1, NULL, 'sortie', 1.0000, 80.0000, 79.0000, NULL, NULL, 'jj', '2026-05-26', 1, '2026-05-26 11:01:58', '2026-05-26 11:01:58');
...
INSERT INTO `paiements` (`id`, `societe_id`, `type_paiement`, `facture_id`, `demande_fonds_id`, `numero`, `montant`, `devise`, `methode`, `compte_tresorerie`, `date_paiement`, `statut`, `ecriture_id`, `user_id`, `notes`, `created_at`, `updated_at`, `deleted_at`) VALUES
(3, 1, 'facture_client', 2, NULL, 'PAY-2026-0001', 8000000.00, 'CDF', 'caisse', '570050', '2026-05-26', 'valide', 12, 1, 'jj', '2026-05-26 11:04:14', '2026-05-26 11:04:14', NULL);
...
(69, 'taches.view', 'web', '2026-05-26 13:11:35', '2026-05-26 13:11:35'),
(70, 'taches.create', 'web', '2026-05-26 13:11:35', '2026-05-26 13:11:35'),
(71, 'taches.update', 'web', '2026-05-26 13:11:35', '2026-05-26 13:11:35'),
(72, 'taches.delete', 'web', '2026-05-26 13:11:35', '2026-05-26 13:11:35'),
(73, 'taches.process', 'web', '2026-05-26 13:11:35', '2026-05-26 13:11:35'),
(74, 'analytique.view', 'web', '2026-05-27 09:52:08', '2026-05-27 09:52:08'),
(75, 'analytique.create', 'web', '2026-05-27 09:52:08', '2026-05-27 09:52:08'),
(76, 'analytique.update', 'web', '2026-05-27 09:52:08', '2026-05-27 09:52:08'),
(77, 'analytique.delete', 'web', '2026-05-27 09:52:08', '2026-05-27 09:52:08'),
(78, 'analytique.export', 'web', '2026-05-27 09:52:08', '2026-05-27 09:52:08');
...
(1144, 1, '57003', 'Caisse Dollars 2', NULL, 5, '57000', 4, 'bilan', 'Compte devise dollars', 'debiteur', 'non_applicable', 1, 0, 0, 0, 0, 0, 0, 0, 'non_soumis', NULL, 1, 0, NULL, '2026-05-25 09:09:42', '2026-05-25 09:09:42', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `plan_comptable_axes`
--

CREATE TABLE `plan_comptable_axes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `societe_id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `produits` (
  ...
  `libelle` varchar(255) NOT NULL,
  `type_article` varchar(20) NOT NULL DEFAULT 'produit',
  `unite` varchar(20) NOT NULL DEFAULT 'UN',
  `prix_unitaire` decimal(18,2) NOT NULL DEFAULT 0.00,
  `prix_unitaire_usd` decimal(18,4) NOT NULL DEFAULT 0.0000,
  `prix_unitaire_cdf` decimal(18,2) NOT NULL DEFAULT 0.00,
  `prix_cdf` decimal(18,2) NOT NULL DEFAULT 0.00,
  `prix_usd` decimal(18,2) NOT NULL DEFAULT 0.00,
  `gestion_stock` tinyint(1) NOT NULL DEFAULT 0,
  `stock_actuel` decimal(18,4) NOT NULL DEFAULT 0.0000,
  `stock_quantite` decimal(18,4) NOT NULL DEFAULT 0.0000,
  `stock_minimum` decimal(18,4) NOT NULL DEFAULT 0.0000,
...
INSERT INTO `produits` (`id`, `societe_id`, `code`, `libelle`, `type_article`, `unite`, `prix_unitaire`, `prix_unitaire_usd`, `prix_unitaire_cdf`, `prix_cdf`, `prix_usd`, `gestion_stock`, `stock_actuel`, `stock_quantite`, `stock_minimum`, `compte_vente`, `compte_achat`, `actif`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, '0025', 'Ordinateur', 'produit', 'U', 85000.00, 50.0000, 85000.00, 0.00, 0.00, 1, 79.0000, 0.0000, 10.0000, '701100', '601100', 1, '2026-05-26 10:55:16', '2026-05-26 11:01:58', NULL);
...
--
-- Déchargement des données de la table `sections_analytiques`
--

INSERT INTO `sections_analytiques` (`id`, `axe_analytique_id`, `societe_id`, `code`, `libelle`, `parent_id`, `budget`, `actif`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'SALAMA', 'Projet Salama', NULL, NULL, 1, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(2, 1, 1, 'EQUITY SITE', 'Projet EQUITY', NULL, NULL, 1, '2026-05-27 09:56:52', '2026-05-27 10:18:33'),
(3, 2, 1, 'TECH', 'Technique', NULL, NULL, 1, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(4, 2, 1, 'COMPTA', 'Comptabilité', NULL, NULL, 1, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(5, 3, 1, 'KIN', 'Kinshasa', NULL, NULL, 1, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(6, 3, 1, 'LUB', 'Lubumbashi', NULL, NULL, 1, '2026-05-27 09:56:52', '2026-05-27 09:56:52'),
(7, 4, 1, 'CCPROJET2', 'MON PROJET CONR', NULL, NULL, 1, '2026-05-27 10:07:08', '2026-05-27 10:07:08');
...
CREATE TABLE `societes` (
  ...
  `forme_juridique` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `pays` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RDC',
  `telephone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `site_web` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rccm` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `num_contribuable` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `identification_nationale` varchar(100) DEFAULT NULL,
  `num_cnps` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `regime_fiscal` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `devise_principale` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'XOF',
  `logo_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `statut` enum('active','inactive','suspendue') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `parametres` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `societes` (`id`, `code`, `raison_sociale`, `forme_juridique`, `sigle`, `adresse`, `ville`, `pays`, `telephone`, `email`, `site_web`, `rccm`, `num_contribuable`, `identification_nationale`, `num_cnps`, `regime_fiscal`, `devise_principale`, `logo_path`, `statut`, `parametres`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, '0001', 'MILLENIUM HORIZON', 'SARL', 'MILLENIUM', '12, Avenue de la Paix', 'Kinshasa', 'République Démocratique du Congo', '+243 97146483', 'tech@milleniumhorizon.com', NULL, ':KIN/RCCM/16 A-35728', 'A1827222K', '01-93-N13593N', NULL, 'Réel normal', 'CDF', 'https://compta.salama-drc.com/logos/1779278991_6a0da48fca1c4.png', 'active', '{\"devise_affichage\":\"CDF\",\"mode_conversion\":\"origine\",\"scope_devise\":\"consolide\"}', '2026-05-17 16:13:11', '2026-05-27 09:36:37', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `societe_banques`
--

CREATE TABLE `societe_banques` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `societe_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Déchargement des données de la table `societe_banques`
--

INSERT INTO `societe_banques` (`id`, `societe_id`, `banque`, `numero_compte`, `devise`, `est_defaut`, `ordre`, `created_at`, `updated_at`) VALUES
(1, 1, 'RAWBANK', '5055221588525871', 'CDF', 1, 0, '2026-05-26 11:54:33', '2026-05-26 11:54:33'),
(2, 1, 'EQUITY BCDC', '8525225225524552', 'USD', 0, 1, '2026-05-26 11:54:33', '2026-05-26 11:54:33');
...
INSERT INTO `taches` (`id`, `societe_id`, `titre`, `description`, `statut`, `cree_par`, `date_echeance`, `created_at`, `updated_at`) VALUES
(1, 1, 'TACHE LIONENL', 'VOICI VOTRE TCAHCEU EBNIUE', 'terminee', 1, '2026-05-29', '2026-05-26 13:15:07', '2026-05-26 13:15:24');

-- --------------------------------------------------------

--
-- Structure de la table `tache_etapes`
--

CREATE TABLE `tache_etapes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `terminee_par` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `tache_etapes`
--

INSERT INTO `tache_etapes` (`id`, `tache_id`, `user_id`, `libelle`, `ordre`, `est_terminee`, `terminee_le`, `terminee_par`, `created_at`, `updated_at`) VALUES
(1, 1, 3, 'FIXER E MUR', 1, 1, '2026-05-26 13:15:21', 1, '2026-05-26 13:15:07', '2026-05-26 13:15:21'),
(2, 1, 3, 'MANGER CECI', 2, 1, '2026-05-26 13:15:24', 1, '2026-05-26 13:15:07', '2026-05-26 13:15:24');

-- --------------------------------------------------------

--
-- Structure de la table `tache_fichiers`
--

CREATE TABLE `tache_fichiers` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `tache_id` bigint(20) UNSIGNED NOT NULL,
  `rapport_id` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `chemin` varchar(255) NOT NULL,
  `nom_fichier` varchar(255) NOT NULL,
  `mime` varchar(120) DEFAULT NULL,
  `taille` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `tache_rapports`
--

CREATE TABLE `tache_rapports` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `tache_id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Déchargement des données de la table `tache_rapports`
--

INSERT INTO `tache_rapports` (`id`, `tache_id`, `user_id`, `contenu`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'VOICI L RAPPORT DE CETTE CAHC', '2026-05-26 13:15:48', '2026-05-26 13:15:48');
...
(3, 1, 'USD', '2026-05-24', 2199.990000, NULL, NULL, 'manuel', '2026-05-24 12:30:09', '2026-05-24 12:30:09'),
(5, 1, 'USD', '2026-05-26', 2300.000001, NULL, NULL, 'manuel', '2026-05-26 12:05:30', '2026-05-26 12:18:24'),
(6, 1, 'USD', '2026-05-27', 2200.000000, NULL, NULL, 'manuel', '2026-05-27 09:00:49', '2026-05-27 09:00:49');
...
(3, 1, '0022', 'UTEX AFRICA', NULL, 'client', '414100', NULL, NULL, NULL, NULL, NULL, 'Kinshasa', NULL, '00000000000', NULL, 'client@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL, '2026-05-25 09:15:02', '2026-05-25 09:15:02', NULL);
...
(1, 'Compte Démo', 'demo@gmail.com', NULL, '$2y$10$UT8R7GpE/C1UPbbsdKhj8O08P5oaXonTt7EmQ10TMcTi4OhHdw3Q.', 'super_admin', 'dK9zUURjIEe52nbjzs0UlR3N7FLIoBexTafecGZ0G8q5SdvUJhiV4779GJ2w', '2026-05-17 16:13:10', '2026-05-27 09:52:09'),
...
(4, 'Super Administrateur', 'admin@millenium-erp.local', NULL, '$2y$10$fiWnesX9R5raRFOXjBdVZe8EZn7LA625eZXVsSh1DeR5aT2ZWvcuW', 'super_admin', NULL, '2026-05-26 13:11:36', '2026-05-27 09:52:09');
...
ALTER TABLE `bons_commande`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `bons_commande_societe_id_numero_unique` (`societe_id`,`numero`),
  ADD KEY `bons_commande_tiers_id_foreign` (`tiers_id`),
  ADD KEY `bons_commande_cree_par_foreign` (`cree_par`);
...
ALTER TABLE `bons_livraison`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `bons_livraison_societe_id_numero_unique` (`societe_id`,`numero`),
  ADD KEY `bons_livraison_bon_commande_id_foreign` (`bon_commande_id`),
  ADD KEY `bons_livraison_tiers_id_foreign` (`tiers_id`),
  ADD KEY `bons_livraison_entrepot_id_foreign` (`entrepot_id`),
  ADD KEY `bons_livraison_cree_par_foreign` (`cree_par`);

--
-- Index pour la table `bon_commande_lignes`
--
ALTER TABLE `bon_commande_lignes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bon_commande_lignes_bon_commande_id_foreign` (`bon_commande_id`),
  ADD KEY `bon_commande_lignes_produit_id_foreign` (`produit_id`);

--
-- Index pour la table `bon_livraison_lignes`
--
ALTER TABLE `bon_livraison_lignes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bon_livraison_lignes_bon_livraison_id_foreign` (`bon_livraison_id`),
  ADD KEY `bon_livraison_lignes_produit_id_foreign` (`produit_id`);
...
ALTER TABLE `demandes_fonds`
  ...
  ADD KEY `demandes_fonds_section_analytique_id_foreign` (`section_analytique_id`);
...
ALTER TABLE `entrepots`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `entrepots_societe_id_code_unique` (`societe_id`,`code`);
...
ALTER TABLE `factures`
  ...
  ADD KEY `factures_section_analytique_id_foreign` (`section_analytique_id`);
...
ALTER TABLE `facture_lignes`
  ...
  ADD KEY `facture_lignes_section_analytique_id_foreign` (`section_analytique_id`);
...
--
-- Index pour la table `lignes_ecritures_analytiques`
--
ALTER TABLE `lignes_ecritures_analytiques`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `lea_ligne_axe_unique` (`ligne_ecriture_id`,`axe_analytique_id`),
  ADD KEY `lignes_ecritures_analytiques_ecriture_id_foreign` (`ecriture_id`),
  ADD KEY `lignes_ecritures_analytiques_exercice_id_foreign` (`exercice_id`),
  ADD KEY `lignes_ecritures_analytiques_journal_id_foreign` (`journal_id`),
  ADD KEY `lignes_ecritures_analytiques_axe_analytique_id_foreign` (`axe_analytique_id`),
  ADD KEY `lignes_ecritures_analytiques_section_analytique_id_foreign` (`section_analytique_id`),
  ADD KEY `lea_societe_exercice_section` (`societe_id`,`exercice_id`,`section_analytique_id`);
...
ALTER TABLE `mouvements_stock`
  ...
  ADD KEY `mouvements_stock_entrepot_id_foreign` (`entrepot_id`),
  ADD KEY `mouvements_stock_user_id_foreign` (`user_id`),
  ADD KEY `mouvements_stock_societe_id_produit_id_date_mouvement_index` (`societe_id`,`produit_id`,`date_mouvement`);
...
--
-- Index pour la table `plan_comptable_axes`
--
ALTER TABLE `plan_comptable_axes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `pca_compte_axe_unique` (`plan_comptable_id`,`axe_analytique_id`),
  ADD KEY `plan_comptable_axes_societe_id_foreign` (`societe_id`),
  ADD KEY `plan_comptable_axes_axe_analytique_id_foreign` (`axe_analytique_id`);
...
--
-- Index pour la table `societe_banques`
--
ALTER TABLE `societe_banques`
  ADD PRIMARY KEY (`id`),
  ADD KEY `societe_banques_societe_id_ordre_index` (`societe_id`,`ordre`);
...
ALTER TABLE `taches`
  ADD PRIMARY KEY (`id`),
  ADD KEY `taches_societe_id_statut_index` (`societe_id`,`statut`),
  ADD KEY `taches_cree_par_societe_id_index` (`cree_par`,`societe_id`);

--
-- Index pour la table `tache_etapes`
--
ALTER TABLE `tache_etapes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tache_etapes_user_id_foreign` (`user_id`),
  ADD KEY `tache_etapes_terminee_par_foreign` (`terminee_par`),
  ADD KEY `tache_etapes_tache_id_user_id_index` (`tache_id`,`user_id`);

--
-- Index pour la table `tache_fichiers`
--
ALTER TABLE `tache_fichiers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tache_fichiers_tache_id_foreign` (`tache_id`),
  ADD KEY `tache_fichiers_rapport_id_foreign` (`rapport_id`),
  ADD KEY `tache_fichiers_user_id_foreign` (`user_id`);

--
-- Index pour la table `tache_rapports`
--
ALTER TABLE `tache_rapports`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tache_rapports_tache_id_foreign` (`tache_id`),
  ADD KEY `tache_rapports_user_id_foreign` (`user_id`);
...
--
-- AUTO_INCREMENT pour la table `bon_commande_lignes`
--
ALTER TABLE `bon_commande_lignes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `bon_livraison_lignes`
--
ALTER TABLE `bon_livraison_lignes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `lignes_ecritures_analytiques`
--
ALTER TABLE `lignes_ecritures_analytiques`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT pour la table `plan_comptable_axes`
--
ALTER TABLE `plan_comptable_axes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `societe_banques`
--
ALTER TABLE `societe_banques`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT pour la table `tache_etapes`
--
ALTER TABLE `tache_etapes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `tache_fichiers`
--
ALTER TABLE `tache_fichiers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `tache_rapports`
--
ALTER TABLE `tache_rapports`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `bons_commande`
  ADD CONSTRAINT `bons_commande_cree_par_foreign` FOREIGN KEY (`cree_par`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `bons_commande_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `bons_commande_tiers_id_foreign` FOREIGN KEY (`tiers_id`) REFERENCES `tiers` (`id`);

--
-- Contraintes pour la table `bons_livraison`
--
ALTER TABLE `bons_livraison`
  ADD CONSTRAINT `bons_livraison_bon_commande_id_foreign` FOREIGN KEY (`bon_commande_id`) REFERENCES `bons_commande` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `bons_livraison_cree_par_foreign` FOREIGN KEY (`cree_par`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `bons_livraison_entrepot_id_foreign` FOREIGN KEY (`entrepot_id`) REFERENCES `entrepots` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `bons_livraison_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `bons_livraison_tiers_id_foreign` FOREIGN KEY (`tiers_id`) REFERENCES `tiers` (`id`);

--
-- Contraintes pour la table `bon_commande_lignes`
--
ALTER TABLE `bon_commande_lignes`
  ADD CONSTRAINT `bon_commande_lignes_bon_commande_id_foreign` FOREIGN KEY (`bon_commande_id`) REFERENCES `bons_commande` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `bon_commande_lignes_produit_id_foreign` FOREIGN KEY (`produit_id`) REFERENCES `produits` (`id`) ON DELETE SET NULL;

--
-- Contraintes pour la table `bon_livraison_lignes`
--
ALTER TABLE `bon_livraison_lignes`
  ADD CONSTRAINT `bon_livraison_lignes_bon_livraison_id_foreign` FOREIGN KEY (`bon_livraison_id`) REFERENCES `bons_livraison` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `bon_livraison_lignes_produit_id_foreign` FOREIGN KEY (`produit_id`) REFERENCES `produits` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `demandes_fonds`
  ...
  ADD CONSTRAINT `demandes_fonds_section_analytique_id_foreign` FOREIGN KEY (`section_analytique_id`) REFERENCES `sections_analytiques` (`id`) ON DELETE SET NULL,
...
--
ALTER TABLE `entrepots`
  ADD CONSTRAINT `entrepots_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `factures`
  ...
  ADD CONSTRAINT `factures_section_analytique_id_foreign` FOREIGN KEY (`section_analytique_id`) REFERENCES `sections_analytiques` (`id`) ON DELETE SET NULL,
...
ALTER TABLE `facture_lignes`
  ...
  ADD CONSTRAINT `facture_lignes_section_analytique_id_foreign` FOREIGN KEY (`section_analytique_id`) REFERENCES `sections_analytiques` (`id`) ON DELETE SET NULL;
...
--
-- Contraintes pour la table `lignes_ecritures_analytiques`
--
ALTER TABLE `lignes_ecritures_analytiques`
  ADD CONSTRAINT `lignes_ecritures_analytiques_axe_analytique_id_foreign` FOREIGN KEY (`axe_analytique_id`) REFERENCES `axes_analytiques` (`id`),
  ADD CONSTRAINT `lignes_ecritures_analytiques_ecriture_id_foreign` FOREIGN KEY (`ecriture_id`) REFERENCES `ecritures` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lignes_ecritures_analytiques_exercice_id_foreign` FOREIGN KEY (`exercice_id`) REFERENCES `exercices` (`id`),
  ADD CONSTRAINT `lignes_ecritures_analytiques_journal_id_foreign` FOREIGN KEY (`journal_id`) REFERENCES `journaux` (`id`),
  ADD CONSTRAINT `lignes_ecritures_analytiques_ligne_ecriture_id_foreign` FOREIGN KEY (`ligne_ecriture_id`) REFERENCES `lignes_ecritures` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lignes_ecritures_analytiques_section_analytique_id_foreign` FOREIGN KEY (`section_analytique_id`) REFERENCES `sections_analytiques` (`id`),
  ADD CONSTRAINT `lignes_ecritures_analytiques_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `mouvements_stock`
  ADD CONSTRAINT `mouvements_stock_entrepot_id_foreign` FOREIGN KEY (`entrepot_id`) REFERENCES `entrepots` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `mouvements_stock_produit_id_foreign` FOREIGN KEY (`produit_id`) REFERENCES `produits` (`id`),
  ADD CONSTRAINT `mouvements_stock_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `mouvements_stock_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
-- Contraintes pour la table `plan_comptable_axes`
--
ALTER TABLE `plan_comptable_axes`
  ADD CONSTRAINT `plan_comptable_axes_axe_analytique_id_foreign` FOREIGN KEY (`axe_analytique_id`) REFERENCES `axes_analytiques` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `plan_comptable_axes_plan_comptable_id_foreign` FOREIGN KEY (`plan_comptable_id`) REFERENCES `plan_comptable` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `plan_comptable_axes_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE;
...
--
-- Contraintes pour la table `societe_banques`
--
ALTER TABLE `societe_banques`
  ADD CONSTRAINT `societe_banques_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `taches`
--
ALTER TABLE `taches`
  ADD CONSTRAINT `taches_cree_par_foreign` FOREIGN KEY (`cree_par`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `taches_societe_id_foreign` FOREIGN KEY (`societe_id`) REFERENCES `societes` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `tache_etapes`
--
ALTER TABLE `tache_etapes`
  ADD CONSTRAINT `tache_etapes_tache_id_foreign` FOREIGN KEY (`tache_id`) REFERENCES `taches` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tache_etapes_terminee_par_foreign` FOREIGN KEY (`terminee_par`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `tache_etapes_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `tache_fichiers`
--
ALTER TABLE `tache_fichiers`
  ADD CONSTRAINT `tache_fichiers_rapport_id_foreign` FOREIGN KEY (`rapport_id`) REFERENCES `tache_rapports` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `tache_fichiers_tache_id_foreign` FOREIGN KEY (`tache_id`) REFERENCES `taches` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tache_fichiers_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `tache_rapports`
--
ALTER TABLE `tache_rapports`
  ADD CONSTRAINT `tache_rapports_tache_id_foreign` FOREIGN KEY (`tache_id`) REFERENCES `taches` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tache_rapports_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
