...
class EtatsController extends Controller
{
    ...
    public function apiBilan(Request $request): JsonResponse
    {
        try {
            ...
            $data = $this->etats->bilan($societeId, $ctx['exercice'], $ctx['dateArrete'], $ctx['devise'], $ctx['mode'], $ctx['n1'], $ctx['scopeDevise']);
    ...
    public function apiCompteResultat(Request $request): JsonResponse
    {
        ...
        $data = $this->etats->compteResultat($societeId, $ctx['exercice'], $ctx['dateArrete'], $ctx['devise'], $ctx['mode'], $ctx['n1'], $ctx['scopeDevise']);
